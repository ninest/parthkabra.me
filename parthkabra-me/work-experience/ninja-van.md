...
Links: [Ninja Van](https://www.ninjavan.co/en-sg)
...
![Ninja Van delivery map stops](/images/work/ninja-van/sf-zoom.png)

And once zoomed out, the 5 points are clustered into one:

![Ninja Van clustered delivery map](/images/work/ninja-van/sf-zoomout.png)

To make it easier to read statuses, we had color-coded each point and added a graph at the bottom:

![Ninja Van parcel status map](/images/work/ninja-van/with-status.png)
