...
![Google Forms form editor](/images/posts/html/google-forms-embed/g-form.png)
...
![Google Forms send dialog](/images/posts/html/google-forms-embed/send.png)
...
![Google Forms embedded preview](/images/posts/html/google-forms-embed/preview.png)
...
![Google Forms HTML source](/images/posts/html/google-forms-embed/source.png)
...
````component:alert
variant: secondary
title: "How exactly do you get the Entry IDs?"
---
...
![Custom Google Forms test form](/images/posts/html/google-forms-embed/form-test.png)

Hit **Submit**.

Now go to the **Responses** section in your Google Form:

![Google Forms submitted response](/images/posts/html/google-forms-embed/response.png)
