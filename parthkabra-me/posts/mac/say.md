...
Links: [Say man page](https://ss64.com/osx/say.html), [Default speaking rate of speech synthesis program](https://apple.stackexchange.com/q/96808/419233), [Mac say command to mp3](https://stackoverflow.com/q/16501663/8677167)
...
![macOS Spoken Content settings](/images/posts/mac/say/spoken_content.png)
...
```component:alert
variant: secondary
title: "Testing out different voices"
---
Go to the **System Preferences** app. Open **Accessibility** > **Spoken Content**. You will see the **System Voice** dropdown.

Scroll to the bottom and click the "Customize" button:

![macOS spoken text shortcut settings](/images/posts/mac/say/customize.png)

You can now browse through all voices, and click "Play" to test them out:

![macOS voice browser](/images/posts/mac/say/browse.png)
```
