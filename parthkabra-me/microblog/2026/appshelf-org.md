...
I'm trying to build a platform for that! Check out [appshelf.org](https://appshelf.org) and join the waitlist!

Links: [AppShelf.org](https://appshelf.org) \
Related: [window.globalStorage](/micro/2026/window-global-storage)
