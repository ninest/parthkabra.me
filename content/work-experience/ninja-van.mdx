...
![Map interface showing individual delivery stops before clustering](/images/work/ninja-van/sf-zoom.png)

And once zoomed out, the 5 points are clustered into one:

![Map interface zoomed out with nearby delivery stops grouped into a cluster](/images/work/ninja-van/sf-zoomout.png)

To make it easier to read statuses, we had color-coded each point and added a graph at the bottom:

![Delivery map with color-coded parcel statuses and a status chart below](/images/work/ninja-van/with-status.png)
